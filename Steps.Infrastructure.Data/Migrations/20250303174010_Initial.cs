    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    JudgingContestsId = table.Column<Guid>(type: "uuid", nullable: false),
                    JudjesId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestUser", x => new { x.JudgingContestsId, x.JudjesId });
                    table.ForeignKey(
                        name: "FK_ContestUser_Contest_JudgingContestsId",
                        column: x => x.JudgingContestsId,
                        principalTable: "Contest",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestUser_User_JudjesId",
                        column: x => x.JudjesId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountingContestsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContestUser1", x => new { x.CountersId, x.CountingContestsId });
                    table.ForeignKey(
                        name: "FK_ContestUser1_Contest_CountingContestsId",
                        column: x => x.CountingContestsId,
                        principalTable: "Contest",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContestUser1_User_CountersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AthleteType = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteEntry", x => new { x.AthletesId, x.EntriesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AthleteEntry_Entries_EntriesId",
            ...
            migrationBuilder.CreateTable(
                name: "AthleteLateAthletesList",
                columns: table => new
                {
                    AthletesId = table.Column<Guid>(type: "uuid", nullable: false),
                    LateAthletesListsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteLateAthletesList", x => new { x.AthletesId, x.LateAthletesListsId });
                    table.ForeignKey(
                        name: "FK_AthleteLateAthletesList_Athletes_AthletesId",
                        column: x => x.AthletesId,
                        principalTable: "Athletes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AthleteLateAthletesList_LateAtheletesLists_LateAthletesList~",
                        column: x => x.LateAthletesListsId,
                        principalTable: "LateAtheletesLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteEntry_EntriesId",
                table: "AthleteEntry",
                column: "EntriesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteLateAthletesList_LateAthletesListsId",
                table: "AthleteLateAthletesList",
                column: "LateAthletesListsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContestUser_JudjesId",
                table: "ContestUser",
                column: "JudjesId");

            migrationBuilder.CreateIndex(
                name: "IX_ContestUser1_CountingContestsId",
                table: "ContestUser1",
                column: "CountingContestsId");
