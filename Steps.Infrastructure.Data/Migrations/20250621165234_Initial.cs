        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreScheduleFileId = table.Column<Guid>(type: "uuid", nullable: true),
                    FinalScheduleFileId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Contests_ScheduleFiles_FinalScheduleFileId",
                        column: x => x.FinalScheduleFileId,
                        principalTable: "ScheduleFiles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contests_ScheduleFiles_PreScheduleFileId",
                        column: x => x.PreScheduleFileId,
                        principalTable: "ScheduleFiles",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contests_FinalScheduleFileId",
                table: "Contests",
                column: "FinalScheduleFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contests_PreScheduleFileId",
                table: "Contests",
                column: "PreScheduleFileId");
